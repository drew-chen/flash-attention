...
V4 uses the same D=64 FA2-style algorithm and warp ownership as V3. V3's
Algorithm section is the canonical ownership and distribution reference. V4
adds a few lower-level optimizations:
