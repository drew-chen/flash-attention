...
/*
V1 tiled FlashAttention forward kernel.
...
Algorithm and optimization notes: docs/v1-extended-notes.md
*/
 ...
 */
__device__ __forceinline__ std::size_t get_batch_head_offset(const std::size_t H,
    ...
    return (batch_idx * H + head_idx) * total_rows * total_cols;
}
